...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObjectFromSender(sender: AnyObject){
        insertNewObject()
    }
...
//        else if segue.identifier == "launcher" {
//            let indexPath = self.tableView.indexPathForSelectedRow()
//            //let object = self.fetchedResultsController.objectAtIndexPath(indexPath) as NSManagedObject
//            //let controller = (segue.destinationViewController as UINavigationController).topViewController as LauncherViewController
//            //controller.detailItem = object
//            //controller.navigationItem.leftBarButtonItem = self.splitViewController.displayModeButtonItem()
//            //controller.navigationItem.leftItemsSupplementBackButton = true
//            self.performSegueWithIdentifier("launcher", sender: self)
//        }
    }
    ...
    var fetchedResultsController: NSFetchedResultsController {
        ...
        let entity = NSEntityDescription.entityForName("OrangePi", inManagedObjectContext: self.managedObjectContext)
